            ...
            <div>
              ...
              <div className="mb-4">
                ...
                >
                  ...
                  <option value="Installation Wi-Fi">Installation Wi-Fi</option>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  >
                    ...
                    <option value="> 50 000 MAD">Plus de 50 000 MAD</option>
                  </select>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="Urgent (< 1 semaine)">Urgent (moins d'une semaine)</option>
                      ...
                      <option value="> 2 mois">Plus de 2 mois</option>
                    </select>
                  </div>
                </div>
              </div>
